...
<head>
    ...
    <title>Tixia Laravel | Dashboard  </title>
    <!-- Favicon icon -->
    ...
    ***********************************-->
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="https://tixia.dexignzone.com/laravel/demo/index" class="brand-logo">
						...
						<ul class="contacts">
							...
							<li class="active dz-chat-user">
								<div class="d-flex bd-highlight">
									<div class="img_cont">
										<img src="https://tixia.dexignzone.com/laravel/demo/images/avatar/1.jpg" class="rounded-circle user_img" alt=""/>
							...
							<li class="dz-chat-user">
								<div class="d-flex bd-highlight">
									<div class="img_cont">
										<img src="https://tixia.dexignzone.com/laravel/demo/images/avatar/2.jpg" class="rounded-circle user_img" alt=""/>
							...
							<li class="dz-chat-user">
								<div class="d-flex bd-highlight">
									<div class="img_cont">
										<img src="https://tixia.dexignzone.com/laravel/demo/images/avatar/3.jpg" class="rounded-circle user_img" alt=""/>
										<span class="online_icon"></span>
									</div>
									<div class="user_info">
							...
							<li class="dz-chat-user">
								<div class="d-flex bd-highlight">
									<div class="img_cont">
										<img src="https://tixia.dexignzone.com/laravel/demo/images/avatar/4.jpg" class="rounded-circle user_img" alt=""/>
										<span class="online_icon offline"></span>
									</div>
									<div class="user_info">
							...
							<li class="dz-chat-user">
								<div class="d-flex bd-highlight">
									<div class="img_cont">
										<img src="https://tixia.dexignzone.com/laravel/demo/images/avatar/5.jpg" class="rounded-circle user_img" alt=""/>
										<span class="online_icon offline"></span>
									</div>
									<div class="user_info">
					...
					<div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
						<div class="d-flex justify-content-start mb-4">
							<div class="img_cont_msg">
								<img src="https://tixia.dexignzone.com/laravel/demo/images/avatar/1.jpg" class="rounded-circle user_img_msg" alt=""/>
							</div>
						...
						<div class="d-flex justify-content-end mb-4">
							...
							<div class="img_cont_msg">
						<img src="https://tixia.dexignzone.com/laravel/demo/images/avatar/2.jpg" class="rounded-circle user_img_msg" alt=""/>
							</div>
						</div>
						<div class="d-flex justify-content-start mb-4">
							<div class="img_cont_msg">
                ...
                <ul class="navbar-nav header-right">
                    ...
                    <li class="nav-item dropdown header-profile">
                        <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
							<img src="https://tixia.dexignzone.com/laravel/demo/images/profile/pic1.jpg" width="20" alt=""/>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end">
                            <a href="https://tixia.dexignzone.com/laravel/demo/app-profile" class="dropdown-item ai-icon">
                                <svg id="icon-user1" xmlns="http://www.w3.org/2000/svg" class="text-primary" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                                <span class="ms-2">Profile </span>
                            </a>
                            <a href="https://tixia.dexignzone.com/laravel/demo/email-inbox" class="dropdown-item ai-icon">
                                <svg id="icon-inbox" xmlns="http://www.w3.org/2000/svg" class="text-success" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                                <span class="ms-2">Inbox </span>
                            </a>
                            <a href="https://tixia.dexignzone.com/laravel/demo/page-login" class="dropdown-item ai-icon">
		...
		<ul class="metismenu" id="menu">
            <li><a class="has-arrow ai-icon" href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
					<li><a href="https://tixia.dexignzone.com/laravel/demo/index">Dashboard</a></li>
					<li><a href="https://tixia.dexignzone.com/laravel/demo/analytics">Analytics</a></li>
					<li><a href="https://tixia.dexignzone.com/laravel/demo/events">Events</a></li>
					<li><a href="https://tixia.dexignzone.com/laravel/demo/order-list">Order List</a></li>
					<li><a href="https://tixia.dexignzone.com/laravel/demo/customer-list">Customer List</a></li>
					<li><a href="https://tixia.dexignzone.com/laravel/demo/reviews">Reviews</a></li>
				</ul>
            </li>
			<li>
                ...
                <ul aria-expanded="false">
					<li><a href="https://tixia.dexignzone.com/laravel/demo/content">Content</a></li>
					<li><a href="https://tixia.dexignzone.com/laravel/demo/menu-1">Menu</a></li>
					<li><a href="https://tixia.dexignzone.com/laravel/demo/email-template">Email Template</a></li>
					<li><a href="https://tixia.dexignzone.com/laravel/demo/blog">Blog</a></li>
				</ul>
            </li>
			<li>
				<a class="has-arrow ai-icon" href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
					<li><a href="https://tixia.dexignzone.com/laravel/demo/create-ticket">Create Ticket</a></li>
					<li><a href="https://tixia.dexignzone.com/laravel/demo/all-ticket">All Ticket</a></li>
				</ul>
            </li>
			<li>
				<a class="has-arrow ai-icon" href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
					<li><a href="https://tixia.dexignzone.com/laravel/demo/customers-list">Customers List</a></li>
					<li><a href="https://tixia.dexignzone.com/laravel/demo/chat">Chat</a></li>
				</ul>
            </li>
            <li>
				<a class="has-arrow ai-icon" href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="https://tixia.dexignzone.com/laravel/demo/app-profile">Profile</a></li>
					<li><a href="https://tixia.dexignzone.com/laravel/demo/edit-profile">Edit Profile <span class="badge badge-xs badge-danger ms-2">New</span></a></li>
                    <li><a class="has-arrow" href="javascript:void(0);" aria-expanded="false">Email</a>
                        <ul aria-expanded="false">
                            <li><a href="https://tixia.dexignzone.com/laravel/demo/email-compose">Compose</a></li>
                            <li><a href="https://tixia.dexignzone.com/laravel/demo/email-inbox">Inbox</a></li>
                            <li><a href="https://tixia.dexignzone.com/laravel/demo/email-read">Read</a></li>
                        </ul>
                    </li>
                    <li><a href="https://tixia.dexignzone.com/laravel/demo/app-calender">Calendar</a></li>
					<li><a class="has-arrow" href="javascript:void(0);" aria-expanded="false">Shop</a>
                        <ul aria-expanded="false">
                            <li><a href="https://tixia.dexignzone.com/laravel/demo/ecom-product-grid">Product Grid</a></li>
							<li><a href="https://tixia.dexignzone.com/laravel/demo/ecom-product-list">Product List</a></li>
							<li><a href="https://tixia.dexignzone.com/laravel/demo/ecom-product-detail">Product Details</a></li>
							<li><a href="https://tixia.dexignzone.com/laravel/demo/ecom-product-order">Order</a></li>
							<li><a href="https://tixia.dexignzone.com/laravel/demo/ecom-checkout">Checkout</a></li>
							<li><a href="https://tixia.dexignzone.com/laravel/demo/ecom-invoice">Invoice</a></li>
							<li><a href="https://tixia.dexignzone.com/laravel/demo/ecom-customers">Customers</a></li>
                        </ul>
                    </li>
                </ul>
            </li>
            <li><a class="has-arrow ai-icon" href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="https://tixia.dexignzone.com/laravel/demo/chart-flot">Flot</a></li>
                    <li><a href="https://tixia.dexignzone.com/laravel/demo/chart-morris">Morris</a></li>
                    <li><a href="https://tixia.dexignzone.com/laravel/demo/chart-chartjs">Chartjs</a></li>
                    <li><a href="https://tixia.dexignzone.com/laravel/demo/chart-chartist">Chartist</a></li>
                    <li><a href="https://tixia.dexignzone.com/laravel/demo/chart-sparkline">Sparkline</a></li>
                    <li><a href="https://tixia.dexignzone.com/laravel/demo/chart-peity">Peity</a></li>
                </ul>
            </li>
            <li><a class="has-arrow ai-icon" href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="https://tixia.dexignzone.com/laravel/demo/ui-accordion">Accordion</a></li>
                    <li><a href="https://tixia.dexignzone.com/laravel/demo/ui-alert">Alert</a></li>
                    <li><a href="https://tixia.dexignzone.com/laravel/demo/ui-badge">Badge</a></li>
                    <li><a href="https://tixia.dexignzone.com/laravel/demo/ui-button">Button</a></li>
                    <li><a href="https://tixia.dexignzone.com/laravel/demo/ui-modal">Modal</a></li>
                    <li><a href="https://tixia.dexignzone.com/laravel/demo/ui-button-group">Button Group</a></li>
                    <li><a href="https://tixia.dexignzone.com/laravel/demo/ui-list-group">List Group</a></li>
                    <li><a href="https://tixia.dexignzone.com/laravel/demo/ui-media-object">Media Object</a></li>
                    <li><a href="https://tixia.dexignzone.com/laravel/demo/ui-card">Cards</a></li>
                    <li><a href="https://tixia.dexignzone.com/laravel/demo/ui-carousel">Carousel</a></li>
                    <li><a href="https://tixia.dexignzone.com/laravel/demo/ui-dropdown">Dropdown</a></li>
                    <li><a href="https://tixia.dexignzone.com/laravel/demo/ui-popover">Popover</a></li>
                    <li><a href="https://tixia.dexignzone.com/laravel/demo/ui-progressbar">Progressbar</a></li>
                    <li><a href="https://tixia.dexignzone.com/laravel/demo/ui-tab">Tab</a></li>
                    <li><a href="https://tixia.dexignzone.com/laravel/demo/ui-typography">Typography</a></li>
                    <li><a href="https://tixia.dexignzone.com/laravel/demo/ui-pagination">Pagination</a></li>
                    <li><a href="https://tixia.dexignzone.com/laravel/demo/ui-grid">Grid</a></li>
            ...
            <li><a class="has-arrow ai-icon" href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="https://tixia.dexignzone.com/laravel/demo/uc-select2">Select 2</a></li>
                    <li><a href="https://tixia.dexignzone.com/laravel/demo/uc-nestable">Nestedable</a></li>
                    <li><a href="https://tixia.dexignzone.com/laravel/demo/uc-noui-slider">Noui Slider</a></li>
                    <li><a href="https://tixia.dexignzone.com/laravel/demo/uc-sweetalert">Sweet Alert</a></li>
                    <li><a href="https://tixia.dexignzone.com/laravel/demo/uc-toastr">Toastr</a></li>
                    <li><a href="https://tixia.dexignzone.com/laravel/demo/map-jqvmap">Jqv Map</a></li>
                    <li><a href="https://tixia.dexignzone.com/laravel/demo/uc-lightgallery">Light Gallery</a></li>
                </ul>
            </li>
            <li><a href="https://tixia.dexignzone.com/laravel/demo/widget-basic" class="ai-icon" aria-expanded="false">
            ...
            <li><a class="has-arrow ai-icon" href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="https://tixia.dexignzone.com/laravel/demo/form-element">Form Elements</a></li>
                    <li><a href="https://tixia.dexignzone.com/laravel/demo/form-wizard">Wizard</a></li>
                    <li><a href="https://tixia.dexignzone.com/laravel/demo/form-ckeditor">Form CkEditor </a></li>
                    <li><a href="https://tixia.dexignzone.com/laravel/demo/form-pickers">Pickers</a></li>
                    <li><a href="https://tixia.dexignzone.com/laravel/demo/form-validation-jquery">Jquery Validate</a></li>
                </ul>
            </li>
            <li><a class="has-arrow ai-icon" href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="https://tixia.dexignzone.com/laravel/demo/table-bootstrap-basic">Bootstrap</a></li>
                    <li><a href="https://tixia.dexignzone.com/laravel/demo/table-datatable-basic">Datatable</a></li>
                </ul>
            </li>
			<li><a href="https://tixia.dexignzone.com/laravel/demo/reports" class="ai-icon" aria-expanded="false">
            ...
            <li><a class="has-arrow ai-icon" href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="https://tixia.dexignzone.com/laravel/demo/page-register">Register <span class="badge badge-xs badge-danger ms-2">New</span></a></li>
                    <li><a href="https://tixia.dexignzone.com/laravel/demo/page-login">Login</a></li>
                    <li><a class="has-arrow" href="javascript:void(0);" aria-expanded="false">Error</a>
                        <ul aria-expanded="false">
                            <li><a href="https://tixia.dexignzone.com/laravel/demo/page-error-400">Error 400</a></li>
                            <li><a href="https://tixia.dexignzone.com/laravel/demo/page-error-403">Error 403</a></li>
                            <li><a href="https://tixia.dexignzone.com/laravel/demo/page-error-404">Error 404</a></li>
                            <li><a href="https://tixia.dexignzone.com/laravel/demo/page-error-500">Error 500</a></li>
                            <li><a href="https://tixia.dexignzone.com/laravel/demo/page-error-503">Error 503</a></li>
                        </ul>
                    </li>
                    <li><a href="https://tixia.dexignzone.com/laravel/demo/page-lock-screen">Lock Screen</a></li>
                </ul>
            </li>
        </ul>
		<div class="copyright">
	...
	<div class="container-fluid">
		...
		<div class="col-xl-12">
						...
						<div class="box">
							...
							<p>Orders Placed</p>
							<a href="/placed" class="btn">See Orders</a>
						</div>
						...
						<div class="box">
							...
							<p>Admin Users</p>
							<a href="/admins" class="btn">See Admins</a>
						</div>
					...
					<div class="card-body timeline pb-2">
						<div class="timeline-panel align-items-end">
							<div class="media me-3">
								<img class="rounded-circle" alt="image" width="50" src="https://tixia.dexignzone.com/laravel/demo/images/avatar/1.jpg">
							</div>
							<div class="media-body">
						...
						<div class="timeline-panel align-items-end">
							<div class="media me-3">
								<img class="rounded-circle" alt="image" width="50" src="https://tixia.dexignzone.com/laravel/demo/images/avatar/2.jpg">
							</div>
							<div class="media-body">
						...
						<div class="timeline-panel align-items-end">
							<div class="media me-3">
								<img class="rounded-circle" alt="image" width="50" src="https://tixia.dexignzone.com/laravel/demo/images/avatar/3.jpg">
							</div>
							<div class="media-body">
						...
						<div class="timeline-panel align-items-end">
							<div class="media me-3">
								<img class="rounded-circle" alt="image" width="50" src="https://tixia.dexignzone.com/laravel/demo/images/avatar/4.jpg">
							</div>
							<div class="media-body">
